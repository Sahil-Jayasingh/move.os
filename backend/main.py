...
async def ai_observe(payload: AIObserveIn):
    ...
    system = (
        ...
        "praise. Ground the line in the specific numbers you were given (reps, depth, symmetry, "
        "cadence, credits, threat) rather than a generic remark that could apply to any session — "
        "vary your phrasing every time and do not reuse stock fitness-app language like 'great "
        "job' or 'keep it up'. Rules: exactly one sentence, under 15 words, no quotation marks, no "
